      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div className="bg-white/95 border-2 border-gray-200 rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 animate-slide-up shadow-lg">
          <div className="text-center mb-6">
            ...
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-secondary-100 to-matcha-100 rounded-full px-6 py-2">
              <span className="text-3xl font-bold bg-gradient-to-r from-secondary-600 to-matcha-600 bg-clip-text text-transparent">
                {orders.length}
              </span>
              <span className="text-gray-700 font-semibold">total drinks</span>
            </div>
          </div>
